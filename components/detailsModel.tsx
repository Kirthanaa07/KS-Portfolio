...
const DetailsForm = ({ modalBody = '', loomLink = '', gitHubLink = '', tryIt = '', children }: { modalBody?: string, loomLink?: string, gitHubLink?: string, tryIt?: string, children?: React.ReactNode }) => {
